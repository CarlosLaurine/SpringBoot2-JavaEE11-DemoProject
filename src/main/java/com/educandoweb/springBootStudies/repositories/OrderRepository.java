...
/*Creating an Order Repository (interface) extending Spring Data JPA's JPA Repository 
  based on the Entity Type and the chosen Id*/

/*OBS: Since OrderRepository is already extending a Spring-Registered Interface JPARepository,
